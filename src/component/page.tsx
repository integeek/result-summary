function Page() {
  return (
    ...
    <div className="flex items-center justify-center h-screen rounded-[32px] drop-shadow-2xl flex-col md:flex-row">
      <div className="relative max-w-screen-lg bg-gray-200 rounded-lg w-128 h-96 grid ">
        ...
        <div className=" px-4 float-left w-1/2 h-full rounded-lg bg-gradient-to-b from-light-slate-blue to-light-royal-blue font-hanken">
          ...
          <div className="flex items-center justify-center w-36 h-36 rounded-full bg-gradient-to-b from-violet-blue to-persian-blue mx-auto mt-auto">
            <div className="flex flex-col items-center">
              <p className="text-white text-5xl font-bold">76</p>
              <p className="text-white">of 100</p>
            </div>
          </div>
          <p className="font-hanken font-bold mt-4 mb-2 text-2xl text-white">Great</p>
